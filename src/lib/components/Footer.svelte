    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start mb-24 gap-12">
            <div class="max-w-xl">
                ...
                <h2 class="text-4xl md:text-5xl font-serif text-gray-900 leading-tight">
                    Transform Your<br />Enterprise Data
                </h2>
            </div>
            <div>
                <a href="mailto:join@biglittlerobots.com" class="rounded-full bg-black px-6 py-3 text-sm font-medium text-white hover:bg-gray-800 transition-colors inline-block">
                    Get Started
                </a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-24 border-t border-gray-100 pt-16">
            <div>
                ...
                <ul class="space-y-4">
                    <li><a href="#services" class="text-xs text-gray-600 hover:text-gray-900">Agentic Workflow Automation</a></li>
                    <li><a href="#services" class="text-xs text-gray-600 hover:text-gray-900">Analytics Engineering</a></li>
                    <li><a href="#services" class="text-xs text-gray-600 hover:text-gray-900">Data Platform Modernization</a></li>
                </ul>
            </div>
            <div>
                <h4 class="text-[10px] font-mono uppercase tracking-widest text-gray-500 mb-6">Industries</h4>
                <ul class="space-y-4">
                    <li><a href="#industries" class="text-xs text-gray-600 hover:text-gray-900">Manufacturing & CPG</a></li>
                    <li><a href="#industries" class="text-xs text-gray-600 hover:text-gray-900">Pharmaceuticals</a></li>
                    <li><a href="#industries" class="text-xs text-gray-600 hover:text-gray-900">Financial Services</a></li>
                </ul>
            </div>
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    <li><a href="#case-studies" class="text-xs text-gray-600 hover:text-gray-900">Case Studies</a></li>
                    <li><a href="mailto:join@biglittlerobots.com" class="text-xs text-gray-600 hover:text-gray-900">Careers</a></li>
                </ul>
            </div>
            <div>
                <h4 class="text-[10px] font-mono uppercase tracking-widest text-gray-500 mb-6">Contact</h4>
                <ul class="space-y-4">
                    <li><a href="mailto:join@biglittlerobots.com" class="text-xs text-gray-600 hover:text-gray-900">Get Started</a></li>
                    <li><a href="mailto:join@biglittlerobots.com" class="text-xs text-gray-600 hover:text-gray-900">join@biglittlerobots.com</a></li>
